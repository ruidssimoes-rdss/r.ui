...
export default function IntroductionPage() {
  return (
    <div className="max-w-3xl">
      {/* Page Title */}
      <h1 className="text-2xl font-semibold tracking-tight text-[var(--docs-text)] mb-2">
        Introduction
      </h1>
      <p className="text-base text-[var(--docs-text-secondary)] mb-10">
        Welcome to r.ui — beautifully designed, accessible components for React Native.
      </p>

      {/* What is r.ui */}
      <section className="mb-10">
        <h2 className="text-lg font-semibold text-[var(--docs-text)] mb-3">
          What is r.ui?
        </h2>
        <p className="text-base text-[var(--docs-text-secondary)] leading-relaxed">
      ...
      {/* Key Features */}
      <section className="mb-10">
        <h2 className="text-lg font-semibold text-[var(--docs-text)] mb-4">
          Key Features
        </h2>
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
          {features.map((feature) => (
            <div
              key={feature.title}
              className="flex items-start gap-3 p-3 rounded-lg border border-[var(--docs-border)] bg-[var(--docs-card-bg)]"
            >
              <div className="flex-shrink-0 text-[var(--docs-text-muted)] mt-0.5">
                <feature.icon />
              </div>
              <div>
                <h3 className="text-sm font-medium text-[var(--docs-text)]">
                  {feature.title}
                </h3>
      ...
      <section className="mb-10">
        ...
        <div className="space-y-4">
          <div className="rounded-lg border border-[var(--docs-code-border)] bg-[var(--docs-code-bg)] overflow-hidden">
            <div className="px-4 py-2 border-b border-[var(--docs-code-border)] text-xs text-[var(--docs-text-muted)]">
              Terminal
            </div>
            <pre className="p-4 overflow-x-auto">
              <code className="text-sm text-[var(--docs-text)]">npx r-ui add button</code>
            </pre>
          </div>
          <div className="rounded-lg border border-[var(--docs-code-border)] bg-[var(--docs-code-bg)] overflow-hidden">
            <div className="px-4 py-2 border-b border-[var(--docs-code-border)] text-xs text-[var(--docs-text-muted)]">
            ...
            <pre className="p-4 overflow-x-auto">
              <code className="text-sm text-[var(--docs-text)]">{`import { Button } from '@/components/ui/button'
      ...
      <section>
        ...
        <div className="flex flex-col gap-2">
          <Link
            ...
            className="group flex items-center justify-between p-3 rounded-lg border border-[var(--docs-border)] hover:border-[var(--docs-text-muted)] bg-[var(--docs-card-bg)] transition-colors"
          >
            <div>
              <span className="text-sm font-medium text-[var(--docs-text)] group-hover:text-[var(--docs-link)]">
                Installation
              </span>
              <span className="text-sm text-[var(--docs-text-muted)] ml-2">
                — Set up r.ui in your project
              </span>
            </div>
            <span className="text-[var(--docs-text-muted)] group-hover:text-[var(--docs-link)] transition-colors">
              →
            </span>
          </Link>
          <Link
