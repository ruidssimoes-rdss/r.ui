...
Learn how to customize r/ui components to match your design system.
...
- Use style props for one-off overrides
- Create wrapper components for reusable variants
- Use the theme system for global changes
- Keep customizations minimal and purposeful

### Don't

- Override styles in ways that break accessibility
- Fight the design system — if you're fighting constantly, consider if r/ui is the right fit
- Duplicate component code unnecessarily
- Ignore the existing variant/size props before adding custom styles
