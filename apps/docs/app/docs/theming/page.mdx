...
r/ui includes a comprehensive design token system with three built-in themes: Dark, Light, and Oatmeal.

## Built-in Themes

### Dark Theme (Default)

A premium dark theme optimized for OLED displays and reduced eye strain:

- Deep blacks (`#050505` base)
...
A unique warm, neutral theme:

- Cream and beige tones
- Earthy, comfortable feel
- Reduced blue light
