...
import { gridData } from '../../../../lib/componentRegistry';
import {
  GridBasicPreview,
  GridResponsivePreview,
  GridSpanPreview,
} from '../../../../components/previews/GridPreviews';

const previewComponents: Record<string, React.ComponentType> = {
  'basic': GridBasicPreview,
  'responsive': GridResponsivePreview,
  'span': GridSpanPreview,
};
