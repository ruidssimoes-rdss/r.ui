...
import { breadcrumbData } from '../../../../lib/componentRegistry';
import {
  BreadcrumbBasicPreview,
  BreadcrumbWithIconsPreview,
  BreadcrumbCollapsedPreview,
} from '../../../../components/previews/BreadcrumbPreviews';

const previewComponents: Record<string, React.ComponentType> = {
  'basic': BreadcrumbBasicPreview,
  'with-icons': BreadcrumbWithIconsPreview,
  'collapsed': BreadcrumbCollapsedPreview,
};
...
function BreadcrumbPageContent() {
