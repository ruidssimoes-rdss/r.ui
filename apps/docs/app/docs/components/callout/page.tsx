...
import { calloutData } from '../../../../lib/componentRegistry';
import {
  CalloutVariantsPreview,
  CalloutDismissiblePreview,
  CalloutWithoutIconPreview,
} from '../../../../components/previews/CalloutPreviews';

// Map variant IDs to preview components
const previewComponents: Record<string, React.ComponentType> = {
  'variants': CalloutVariantsPreview,
  'dismissible': CalloutDismissiblePreview,
  'without-icon': CalloutWithoutIconPreview,
};
...
function CalloutPageContent() {
  const searchParams = useSearchParams();
  const variantParam = searchParams.get('variant');

  return (
    <PlaygroundLayout
      componentData={calloutData}
      initialVariantId={variantParam || 'variants'}
