...
import { separatorData } from '../../../../lib/componentRegistry';
import {
  SeparatorBasicPreview,
  SeparatorVerticalPreview,
  SeparatorWithLabelPreview,
  SeparatorInCardPreview,
} from '../../../../components/previews/SeparatorPreviews';

// Map variant IDs to preview components
const previewComponents: Record<string, React.ComponentType> = {
  'basic': SeparatorBasicPreview,
  'vertical': SeparatorVerticalPreview,
  'with-label': SeparatorWithLabelPreview,
  'in-card': SeparatorInCardPreview,
};
...
function SeparatorPageContent() {
  const searchParams = useSearchParams();
  const variantParam = searchParams.get('variant');

  return (
    <PlaygroundLayout
      componentData={separatorData}
