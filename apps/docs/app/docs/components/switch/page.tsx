...
import { switchData } from '../../../../lib/componentRegistry';
import {
  SwitchBasicPreview,
  SwitchWithLabelPreview,
  SwitchDisabledPreview,
} from '../../../../components/previews/SwitchPreviews';

// Map variant IDs to preview components
const previewComponents: Record<string, React.ComponentType> = {
  'basic': SwitchBasicPreview,
  'with-label': SwitchWithLabelPreview,
  'disabled': SwitchDisabledPreview,
};
