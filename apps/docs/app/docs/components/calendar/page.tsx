...
import { calendarData } from '../../../../lib/componentRegistry';
import {
  CalendarBasicPreview,
  CalendarRangePreview,
  CalendarMultiplePreview,
} from '../../../../components/previews/CalendarPreviews';

// Map variant IDs to preview components
const previewComponents: Record<string, React.ComponentType> = {
  'basic': CalendarBasicPreview,
  'range': CalendarRangePreview,
  'multiple': CalendarMultiplePreview,
};
