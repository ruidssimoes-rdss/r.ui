...
import { sidebarData } from '../../../../lib/componentRegistry';
import {
  SidebarBasicPreview,
  SidebarWithGroupsPreview,
  SidebarCollapsiblePreview,
} from '../../../../components/previews/SidebarPreviews';

// Map variant IDs to preview components
const previewComponents: Record<string, React.ComponentType> = {
  'basic': SidebarBasicPreview,
  'with-groups': SidebarWithGroupsPreview,
  'collapsible': SidebarCollapsiblePreview,
};
