...
import { actionSheetData } from '../../../../lib/componentRegistry';
import {
  ActionSheetBasicPreview,
  ActionSheetDestructivePreview,
  ActionSheetWithCancelPreview,
} from '../../../../components/previews/ActionSheetPreviews';

const previewComponents: Record<string, React.ComponentType> = {
  'basic': ActionSheetBasicPreview,
  'destructive': ActionSheetDestructivePreview,
  'with-cancel': ActionSheetWithCancelPreview,
};
...
function ActionSheetPageContent() {
  const searchParams = useSearchParams();
  const variantParam = searchParams.get('variant');

  return (
    <PlaygroundLayout
      componentData={actionSheetData}
