...
import { commandData } from '../../../../lib/componentRegistry';
import {
  CommandBasicPreview,
  CommandWithGroupsPreview,
  CommandDialogPreview,
} from '../../../../components/previews/CommandPreviews';

const previewComponents: Record<string, React.ComponentType> = {
  'basic': CommandBasicPreview,
  'with-groups': CommandWithGroupsPreview,
  'dialog': CommandDialogPreview,
};
