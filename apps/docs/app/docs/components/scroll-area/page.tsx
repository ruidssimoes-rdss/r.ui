...
import { scrollAreaData } from '../../../../lib/componentRegistry';
import {
  ScrollAreaVerticalPreview,
  ScrollAreaHorizontalPreview,
  ScrollAreaBothPreview,
} from '../../../../components/previews/ScrollAreaPreviews';

const previewComponents: Record<string, React.ComponentType> = {
  'vertical': ScrollAreaVerticalPreview,
  'horizontal': ScrollAreaHorizontalPreview,
  'both': ScrollAreaBothPreview,
};
