...
import { formData } from '../../../../lib/componentRegistry';
import {
  FormBasicPreview,
  FormWithValidationPreview,
  FormHorizontalPreview,
} from '../../../../components/previews/FormPreviews';

// Map variant IDs to preview components
const previewComponents: Record<string, React.ComponentType> = {
  'basic': FormBasicPreview,
  'with-validation': FormWithValidationPreview,
  'horizontal': FormHorizontalPreview,
};
