...
import { spacerData } from '../../../../lib/componentRegistry';
import {
  SpacerVerticalPreview,
  SpacerHorizontalPreview,
  SpacerSizesPreview,
} from '../../../../components/previews/SpacerPreviews';

const previewComponents: Record<string, React.ComponentType> = {
  'vertical': SpacerVerticalPreview,
  'horizontal': SpacerHorizontalPreview,
  'sizes': SpacerSizesPreview,
};
...
function SpacerPageContent() {
  const searchParams = useSearchParams();
  const variantParam = searchParams.get('variant');

  return (
    <PlaygroundLayout
      componentData={spacerData}
      initialVariantId={variantParam || 'vertical'}
