...
import { sliderData } from '../../../../lib/componentRegistry';
import {
  SliderBasicPreview,
  SliderWithLabelsPreview,
  SliderRangePreview,
  SliderDisabledPreview,
} from '../../../../components/previews/SliderPreviews';

// Map variant IDs to preview components
const previewComponents: Record<string, React.ComponentType> = {
  'basic': SliderBasicPreview,
  'with-labels': SliderWithLabelsPreview,
  'range': SliderRangePreview,
  'disabled': SliderDisabledPreview,
};
