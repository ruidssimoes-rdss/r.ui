...
import { aspectRatioData } from '../../../../lib/componentRegistry';
import {
  AspectRatioVideoPreview,
  AspectRatioSquarePreview,
  AspectRatioImagePreview,
} from '../../../../components/previews/AspectRatioPreviews';

const previewComponents: Record<string, React.ComponentType> = {
  'video': AspectRatioVideoPreview,
  'square': AspectRatioSquarePreview,
  'image': AspectRatioImagePreview,
};
...
function AspectRatioPageContent() {
  const searchParams = useSearchParams();
  const variantParam = searchParams.get('variant');

  return (
    <PlaygroundLayout
      componentData={aspectRatioData}
      initialVariantId={variantParam || 'video'}
