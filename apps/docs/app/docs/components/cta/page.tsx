...
import { ctaData } from '../../../../lib/componentRegistry';
import {
  CTABannerPreview,
  CTACardPreview,
  CTAInlinePreview,
  ...
  CTAGradientPreview,
  CTAMinimalPreview,
} from '../../../../components/previews/CTAPreviews';

// Map variant IDs to preview components
const previewComponents: Record<string, React.ComponentType> = {
  'banner': CTABannerPreview,
  'card': CTACardPreview,
  'inline': CTAInlinePreview,
  'with-image': CTAWithImagePreview,
  'gradient': CTAGradientPreview,
  'minimal': CTAMinimalPreview,
};
...
function CTAPageContent() {
  const searchParams = useSearchParams();
  const variantParam = searchParams.get('variant');

  return (
    <PlaygroundLayout
      componentData={ctaData}
      initialVariantId={variantParam || 'banner'}
