...
import { carouselData } from '../../../../lib/componentRegistry';
import {
  CarouselBasicPreview,
  CarouselWithDotsPreview,
  CarouselWithArrowsPreview,
  CarouselAutoplayPreview,
} from '../../../../components/previews/CarouselPreviews';

const previewComponents: Record<string, React.ComponentType> = {
  'basic': CarouselBasicPreview,
  'with-dots': CarouselWithDotsPreview,
  'with-arrows': CarouselWithArrowsPreview,
  'autoplay': CarouselAutoplayPreview,
};
