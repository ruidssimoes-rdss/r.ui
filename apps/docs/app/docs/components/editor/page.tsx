...
import { editorData } from '../../../../lib/componentRegistry';
import {
  EditorBasicPreview,
  EditorFullToolbarPreview,
  EditorWithCharacterCountPreview,
  EditorDisabledPreview,
} from '../../../../components/previews/EditorPreviews';

// Map variant IDs to preview components
const previewComponents: Record<string, React.ComponentType> = {
  'basic': EditorBasicPreview,
  'full-toolbar': EditorFullToolbarPreview,
  'with-character-count': EditorWithCharacterCountPreview,
  'disabled': EditorDisabledPreview,
};
