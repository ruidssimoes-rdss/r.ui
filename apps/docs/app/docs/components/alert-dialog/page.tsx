...
import { alertDialogData } from '../../../../lib/componentRegistry';
import {
  AlertDialogBasicPreview,
  AlertDialogDestructivePreview,
  AlertDialogWithInputPreview,
} from '../../../../components/previews/AlertDialogPreviews';

const previewComponents: Record<string, React.ComponentType> = {
  'basic': AlertDialogBasicPreview,
  'destructive': AlertDialogDestructivePreview,
  'with-input': AlertDialogWithInputPreview,
};
...
function AlertDialogPageContent() {
  const searchParams = useSearchParams();
  const variantParam = searchParams.get('variant');

  return (
    <PlaygroundLayout
      componentData={alertDialogData}
