...
import { selectData } from '../../../../lib/componentRegistry';
import {
  SelectBasicPreview,
  SelectWithLabelPreview,
  SelectDisabledOptionsPreview,
  SelectDisabledPreview,
} from '../../../../components/previews/SelectPreviews';

// Map variant IDs to preview components
const previewComponents: Record<string, React.ComponentType> = {
  'basic': SelectBasicPreview,
  'with-label': SelectWithLabelPreview,
  'disabled-options': SelectDisabledOptionsPreview,
  'disabled': SelectDisabledPreview,
};
