...
import { radioGroupData } from '../../../../lib/componentRegistry';
import {
  RadioGroupBasicPreview,
  RadioGroupWithDescriptionsPreview,
  RadioGroupDisabledPreview,
  RadioGroupCardsPreview,
} from '../../../../components/previews/RadioGroupPreviews';

// Map variant IDs to preview components
const previewComponents: Record<string, React.ComponentType> = {
  'basic': RadioGroupBasicPreview,
  'with-descriptions': RadioGroupWithDescriptionsPreview,
  'disabled': RadioGroupDisabledPreview,
  'cards': RadioGroupCardsPreview,
};
...
function RadioGroupPageContent() {
  const searchParams = useSearchParams();
  const variantParam = searchParams.get('variant');

  return (
    <PlaygroundLayout
      componentData={radioGroupData}
