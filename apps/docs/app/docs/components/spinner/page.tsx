...
import { spinnerData } from '../../../../lib/componentRegistry';
import {
  SpinnerBasicPreview,
  SpinnerSizesPreview,
  SpinnerColorsPreview,
  SpinnerWithTextPreview,
} from '../../../../components/previews/SpinnerPreviews';

// Map variant IDs to preview components
const previewComponents: Record<string, React.ComponentType> = {
  'basic': SpinnerBasicPreview,
  'sizes': SpinnerSizesPreview,
  'colors': SpinnerColorsPreview,
  'with-text': SpinnerWithTextPreview,
};
