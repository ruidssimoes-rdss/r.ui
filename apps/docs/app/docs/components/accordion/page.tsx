...
import { accordionData } from '../../../../lib/componentRegistry';
import {
  AccordionBasicPreview,
  AccordionMultiplePreview,
  AccordionWithContentPreview,
} from '../../../../components/previews/AccordionPreviews';

// Map variant IDs to preview components
const previewComponents: Record<string, React.ComponentType> = {
  'basic': AccordionBasicPreview,
  'multiple': AccordionMultiplePreview,
  'with-content': AccordionWithContentPreview,
};
