...
import { popoverData } from '../../../../lib/componentRegistry';
import {
  PopoverBasicPreview,
  PopoverWithFormPreview,
  PopoverMenuPreview,
} from '../../../../components/previews/PopoverPreviews';

// Map variant IDs to preview components
const previewComponents: Record<string, React.ComponentType> = {
  'basic': PopoverBasicPreview,
  'with-form': PopoverWithFormPreview,
  'menu': PopoverMenuPreview,
};
