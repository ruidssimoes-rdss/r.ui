...
import { headingData } from '../../../../lib/componentRegistry';
import {
  HeadingBasicPreview,
  HeadingLevelsPreview,
  HeadingWithDescriptionPreview,
} from '../../../../components/previews/HeadingPreviews';

const previewComponents: Record<string, React.ComponentType> = {
  'basic': HeadingBasicPreview,
  'levels': HeadingLevelsPreview,
  'with-description': HeadingWithDescriptionPreview,
};
...
function HeadingPageContent() {
  const searchParams = useSearchParams();
  const variantParam = searchParams.get('variant');

  return (
    <PlaygroundLayout
      componentData={headingData}
