...
import { textareaData } from '../../../../lib/componentRegistry';
import {
  TextareaBasicPreview,
  TextareaWithLabelPreview,
  TextareaDisabledPreview,
  TextareaErrorPreview,
} from '../../../../components/previews/TextareaPreviews';

// Map variant IDs to preview components
const previewComponents: Record<string, React.ComponentType> = {
  'basic': TextareaBasicPreview,
  'with-label': TextareaWithLabelPreview,
  'disabled': TextareaDisabledPreview,
  'error': TextareaErrorPreview,
};
