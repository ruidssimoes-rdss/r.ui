...
import { inputData } from '../../../../lib/componentRegistry';
import {
  InputBasicPreview,
...
} from '../../../../components/previews/InputPreviews';

// Map variant IDs to preview components
const previewComponents: Record<string, React.ComponentType> = {
  'basic': InputBasicPreview,
  'with-label': InputWithLabelPreview,
  'error': InputErrorPreview,
  'sizes': InputSizesPreview,
  'disabled': InputDisabledPreview,
};
