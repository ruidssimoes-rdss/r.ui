...
import { collapsibleData } from '../../../../lib/componentRegistry';
import {
  CollapsibleBasicPreview,
  CollapsibleWithContentPreview,
  CollapsibleFAQPreview,
} from '../../../../components/previews/CollapsiblePreviews';

// Map variant IDs to preview components
const previewComponents: Record<string, React.ComponentType> = {
  'basic': CollapsibleBasicPreview,
  'with-content': CollapsibleWithContentPreview,
  'faq': CollapsibleFAQPreview,
};
...
function CollapsiblePageContent() {
  const searchParams = useSearchParams();
  const variantParam = searchParams.get('variant');

  return (
    <PlaygroundLayout
      componentData={collapsibleData}
