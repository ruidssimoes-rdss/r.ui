...
import { dropdownData } from '../../../../lib/componentRegistry';
import {
  DropdownBasicPreview,
  DropdownWithIconsPreview,
  DropdownDisabledItemsPreview,
} from '../../../../components/previews/DropdownPreviews';

// Map variant IDs to preview components
const previewComponents: Record<string, React.ComponentType> = {
  'basic': DropdownBasicPreview,
  'with-icons': DropdownWithIconsPreview,
  'disabled-items': DropdownDisabledItemsPreview,
};
