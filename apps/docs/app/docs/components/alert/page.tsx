...
import { alertData } from '../../../../lib/componentRegistry';
import {
  AlertBasicPreview,
  AlertVariantsPreview,
  AlertWithoutTitlePreview,
} from '../../../../components/previews/AlertPreviews';

// Map variant IDs to preview components
const previewComponents: Record<string, React.ComponentType> = {
  'basic': AlertBasicPreview,
  'variants': AlertVariantsPreview,
  'without-title': AlertWithoutTitlePreview,
};
