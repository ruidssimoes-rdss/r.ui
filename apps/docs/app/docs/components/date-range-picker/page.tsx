...
import { dateRangePickerData } from '../../../../lib/componentRegistry';
import {
...
} from '../../../../components/previews/DateRangePickerPreviews';

// Map variant IDs to preview components
const previewComponents: Record<string, React.ComponentType> = {
  'basic': DateRangePickerBasicPreview,
  'with-default': DateRangePickerWithDefaultPreview,
  'with-presets': DateRangePickerWithPresetsPreview,
  'no-presets': DateRangePickerNoPresetsPreview,
  'with-min-max': DateRangePickerWithMinMaxPreview,
  'disabled': DateRangePickerDisabledPreview,
};
...
function DateRangePickerPageContent() {
  const searchParams = useSearchParams();
  const variantParam = searchParams.get('variant');

  return (
    <PlaygroundLayout
      componentData={dateRangePickerData}
