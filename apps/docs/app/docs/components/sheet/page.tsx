...
import { sheetData } from '../../../../lib/componentRegistry';
import {
  SheetBasicPreview,
  SheetBottomPreview,
  SheetWithFormPreview,
} from '../../../../components/previews/SheetPreviews';

// Map variant IDs to preview components
const previewComponents: Record<string, React.ComponentType> = {
  'basic': SheetBasicPreview,
  'bottom': SheetBottomPreview,
  'with-form': SheetWithFormPreview,
};
