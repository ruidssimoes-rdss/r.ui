...
import { dialogData } from '../../../../lib/componentRegistry';
import {
  DialogBasicPreview,
  DialogWithFormPreview,
  DialogAlertPreview,
} from '../../../../components/previews/DialogPreviews';

// Map variant IDs to preview components
const previewComponents: Record<string, React.ComponentType> = {
  'basic': DialogBasicPreview,
  'with-form': DialogWithFormPreview,
  'alert': DialogAlertPreview,
};
