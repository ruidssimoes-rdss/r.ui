...
import { testimonialData } from '../../../../lib/componentRegistry';
import {
...
} from '../../../../components/previews/TestimonialPreviews';

// Map variant IDs to preview components
const previewComponents: Record<string, React.ComponentType> = {
  'basic': TestimonialBasicPreview,
  'large': TestimonialLargePreview,
  'with-avatar': TestimonialWithAvatarPreview,
  'with-rating': TestimonialWithRatingPreview,
  'carousel': TestimonialCarouselPreview,
  'grid': TestimonialGridPreview,
};
