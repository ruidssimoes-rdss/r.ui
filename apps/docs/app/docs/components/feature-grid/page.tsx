...
import { featureGridData } from '../../../../lib/componentRegistry';
import {
...
} from '../../../../components/previews/FeatureGridPreviews';

// Map variant IDs to preview components
const previewComponents: Record<string, React.ComponentType> = {
  'basic': FeatureGridBasicPreview,
  'two-columns': FeatureGridTwoColumnsPreview,
  'with-links': FeatureGridWithLinksPreview,
  'glass': FeatureGridGlassPreview,
  'centered': FeatureGridCenteredPreview,
  'horizontal': FeatureGridHorizontalPreview,
};
...
function FeatureGridPageContent() {
  const searchParams = useSearchParams();
  const variantParam = searchParams.get('variant');

  return (
    <PlaygroundLayout
      componentData={featureGridData}
