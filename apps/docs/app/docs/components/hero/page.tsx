...
import { heroData } from '../../../../lib/componentRegistry';
import {
  HeroCenteredPreview,
  HeroSplitPreview,
...
} from '../../../../components/previews/HeroPreviews';

// Map variant IDs to preview components
const previewComponents: Record<string, React.ComponentType> = {
  'centered': HeroCenteredPreview,
  'split': HeroSplitPreview,
  'background-image': HeroBackgroundImagePreview,
  'gradient-text': HeroGradientTextPreview,
  'minimal': HeroMinimalPreview,
  'with-badge': HeroWithBadgePreview,
};
...
function HeroPageContent() {
  ...
  return (
    <PlaygroundLayout
      ...
      initialVariantId={variantParam || 'centered'}
