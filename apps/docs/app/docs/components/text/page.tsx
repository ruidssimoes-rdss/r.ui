...
import { textData } from '../../../../lib/componentRegistry';
import {
  TextBasicPreview,
  TextSizesPreview,
  TextWeightsPreview,
  TextColorsPreview,
} from '../../../../components/previews/TextPreviews';

const previewComponents: Record<string, React.ComponentType> = {
  'basic': TextBasicPreview,
  'sizes': TextSizesPreview,
  'weights': TextWeightsPreview,
  'colors': TextColorsPreview,
};
