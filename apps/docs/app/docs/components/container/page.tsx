...
import { containerData } from '../../../../lib/componentRegistry';
import {
  ContainerBasicPreview,
  ContainerSizesPreview,
  ContainerWithPaddingPreview,
} from '../../../../components/previews/ContainerPreviews';

const previewComponents: Record<string, React.ComponentType> = {
  'basic': ContainerBasicPreview,
  'sizes': ContainerSizesPreview,
  'with-padding': ContainerWithPaddingPreview,
};
