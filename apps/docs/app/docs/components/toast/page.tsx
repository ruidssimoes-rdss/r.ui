...
import { toastData } from '../../../../lib/componentRegistry';
import {
  ToastBasicPreview,
  ToastVariantsPreview,
  ToastStaticPreview,
} from '../../../../components/previews/ToastPreviews';

// Map variant IDs to preview components
const previewComponents: Record<string, React.ComponentType> = {
  'basic': ToastBasicPreview,
  'variants': ToastVariantsPreview,
  'static': ToastStaticPreview,
};
