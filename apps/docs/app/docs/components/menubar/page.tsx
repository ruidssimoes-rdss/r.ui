...
import { menubarData } from '../../../../lib/componentRegistry';
import {
  MenubarBasicPreview,
  MenubarWithShortcutsPreview,
  MenubarWithSubmenusPreview,
} from '../../../../components/previews/MenubarPreviews';

const previewComponents: Record<string, React.ComponentType> = {
  'basic': MenubarBasicPreview,
  'with-shortcuts': MenubarWithShortcutsPreview,
  'with-submenus': MenubarWithSubmenusPreview,
};
...
function MenubarPageContent() {
  const searchParams = useSearchParams();
  const variantParam = searchParams.get('variant');

  return (
    <PlaygroundLayout
      componentData={menubarData}
