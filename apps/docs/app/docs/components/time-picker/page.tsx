...
import { timePickerData } from '../../../../lib/componentRegistry';
import {
...
} from '../../../../components/previews/TimePickerPreviews';

// Map variant IDs to preview components
const previewComponents: Record<string, React.ComponentType> = {
  'basic': TimePickerBasicPreview,
  'with-default': TimePickerWithDefaultPreview,
  '24-hour': TimePicker24HourPreview,
  'with-interval': TimePickerWithIntervalPreview,
  'with-min-max': TimePickerWithMinMaxPreview,
  'disabled': TimePickerDisabledPreview,
};
...
function TimePickerPageContent() {
