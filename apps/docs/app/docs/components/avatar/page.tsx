...
import { avatarData } from '../../../../lib/componentRegistry';
import {
  AvatarBasicPreview,
  AvatarSizesPreview,
  AvatarGroupPreview,
  AvatarWithStatusPreview,
} from '../../../../components/previews/AvatarPreviews';

// Map variant IDs to preview components
const previewComponents: Record<string, React.ComponentType> = {
  'basic': AvatarBasicPreview,
  'sizes': AvatarSizesPreview,
  'group': AvatarGroupPreview,
  'with-status': AvatarWithStatusPreview,
};
