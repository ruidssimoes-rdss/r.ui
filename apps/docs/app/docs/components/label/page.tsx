...
import { labelData } from '../../../../lib/componentRegistry';
import {
  LabelBasicPreview,
  LabelWithInputPreview,
  LabelRequiredPreview,
} from '../../../../components/previews/LabelPreviews';

const previewComponents: Record<string, React.ComponentType> = {
  'basic': LabelBasicPreview,
  'with-input': LabelWithInputPreview,
  'required': LabelRequiredPreview,
};
