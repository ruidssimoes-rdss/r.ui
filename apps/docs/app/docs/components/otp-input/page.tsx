...
import { otpInputData } from '../../../../lib/componentRegistry';
import {
...
} from '../../../../components/previews/OTPInputPreviews';

// Map variant IDs to preview components
const previewComponents: Record<string, React.ComponentType> = {
  'basic': OTPInputBasicPreview,
  'with-separator': OTPInputWithSeparatorPreview,
  'four-digits': OTPInputFourDigitsPreview,
  'masked': OTPInputMaskedPreview,
  'error': OTPInputErrorPreview,
  'disabled': OTPInputDisabledPreview,
};
...
function OTPInputPageContent() {
  const searchParams = useSearchParams();
  const variantParam = searchParams.get('variant');

  return (
    <PlaygroundLayout
      componentData={otpInputData}
