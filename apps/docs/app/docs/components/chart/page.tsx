...
import { chartData } from '../../../../lib/componentRegistry';
import {
  ChartBarPreview,
  ChartLinePreview,
  ChartPiePreview,
  ChartDonutPreview,
} from '../../../../components/previews/ChartPreviews';

// Map variant IDs to preview components
const previewComponents: Record<string, React.ComponentType> = {
  'bar': ChartBarPreview,
  'line': ChartLinePreview,
  'pie': ChartPiePreview,
  'donut': ChartDonutPreview,
};
...
function ChartPageContent() {
  ...
  return (
    <PlaygroundLayout
      componentData={chartData}
      initialVariantId={variantParam || 'bar'}
