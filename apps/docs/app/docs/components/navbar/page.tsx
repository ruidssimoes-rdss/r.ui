...
import { navbarData } from '../../../../lib/componentRegistry';
import {
  NavbarBasicPreview,
  NavbarWithMobileMenuPreview,
  NavbarBorderedPreview,
  NavbarBlurredPreview,
} from '../../../../components/previews/NavbarPreviews';

// Map variant IDs to preview components
const previewComponents: Record<string, React.ComponentType> = {
  'basic': NavbarBasicPreview,
  'with-mobile-menu': NavbarWithMobileMenuPreview,
  'bordered': NavbarBorderedPreview,
  'blurred': NavbarBlurredPreview,
};
...
function NavbarPageContent() {
  const searchParams = useSearchParams();
  const variantParam = searchParams.get('variant');

  return (
    <PlaygroundLayout
      componentData={navbarData}
