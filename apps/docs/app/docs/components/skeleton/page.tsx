...
import { skeletonData } from '../../../../lib/componentRegistry';
import {
  SkeletonBasicPreview,
  SkeletonCardPreview,
  SkeletonTablePreview,
  SkeletonListPreview,
} from '../../../../components/previews/SkeletonPreviews';

// Map variant IDs to preview components
const previewComponents: Record<string, React.ComponentType> = {
  'basic': SkeletonBasicPreview,
  'card': SkeletonCardPreview,
  'table': SkeletonTablePreview,
  'list': SkeletonListPreview,
};
