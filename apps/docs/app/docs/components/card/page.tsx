...
import { cardData } from '../../../../lib/componentRegistry';
import {
  CardBasicPreview,
...
const previewComponents: Record<string, React.ComponentType> = {
  'basic': CardBasicPreview,
  'with-header': CardWithHeaderPreview,
  'with-image': CardWithImagePreview,
  'interactive': CardInteractivePreview,
};
